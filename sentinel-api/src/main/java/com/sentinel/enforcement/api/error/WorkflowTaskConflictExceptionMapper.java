...
@Provider
public final class WorkflowTaskConflictExceptionMapper
    implements ExceptionMapper<WorkflowTaskConflictException> {
  @Context private ContainerRequestContext requestContext;

  @Override
  public Response toResponse(WorkflowTaskConflictException exception) {
    ErrorResponse error =
