...
@Provider
public final class EvidenceConflictExceptionMapper
    implements ExceptionMapper<EvidenceConflictException> {
  @Context private ContainerRequestContext requestContext;

  @Override
  public Response toResponse(EvidenceConflictException exception) {
    ErrorResponse error =
