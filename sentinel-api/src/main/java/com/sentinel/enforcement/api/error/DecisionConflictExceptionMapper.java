...
@Provider
public final class DecisionConflictExceptionMapper
    implements ExceptionMapper<DecisionConflictException> {
  @Context private ContainerRequestContext requestContext;

  @Override
  public Response toResponse(DecisionConflictException exception) {
    ErrorResponse error =
