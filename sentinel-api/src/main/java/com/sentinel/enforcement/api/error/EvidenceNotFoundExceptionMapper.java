...
import com.sentinel.enforcement.application.evidence.EvidenceNotFoundException;
...
@Provider
public final class EvidenceNotFoundExceptionMapper
    implements ExceptionMapper<EvidenceNotFoundException> {
  @Context private ContainerRequestContext requestContext;

  @Override
  public Response toResponse(EvidenceNotFoundException exception) {
    ErrorResponse error =
