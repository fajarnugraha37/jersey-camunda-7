...
@Provider
public final class RecommendationConflictExceptionMapper
    implements ExceptionMapper<RecommendationConflictException> {
  @Context private ContainerRequestContext requestContext;

  @Override
  public Response toResponse(RecommendationConflictException exception) {
    ErrorResponse error =
