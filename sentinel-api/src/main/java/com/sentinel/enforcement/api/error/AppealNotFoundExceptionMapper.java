...
import com.sentinel.enforcement.application.appeal.AppealNotFoundException;
...
@Provider
public final class AppealNotFoundExceptionMapper
    implements ExceptionMapper<AppealNotFoundException> {
  @Context private ContainerRequestContext requestContext;

  @Override
  public Response toResponse(AppealNotFoundException exception) {
    ErrorResponse error =
